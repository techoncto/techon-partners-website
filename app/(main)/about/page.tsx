      ...
      <section className="py-24 bg-slate-50" aria-labelledby="founder-heading">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 items-start">
            <div className="rounded-2xl bg-navy-900 overflow-hidden">
              <div className="aspect-[4/3] bg-navy-800 flex items-center justify-center relative">
                ...
                <div className="relative text-center">
                  <div className="w-20 h-20 rounded-full bg-navy-700 border-2 border-navy-600 mx-auto mb-3 flex items-center justify-center">
                    <svg className="w-10 h-10 text-slate-500" viewBox="0 0 24 24" fill="currentColor" aria-label="Profile photo placeholder">
              ...
              <div className="p-6 border-t border-white/[0.06]">
                ...
                <div className="mt-3 pt-3 border-t border-white/[0.06] flex items-center justify-between">
                  ...
                  <a href="https://www.linkedin.com/in/isaacdrezdner" target="_blank" rel="noopener noreferrer" className="text-slate-500 text-xs hover:text-slate-300 transition-colors">
                    LinkedIn &rarr;
                  </a>
                </div>
              </div>
            ...
            <div>
              <p className="text-blue-600 text-xs font-semibold tracking-[0.2em] uppercase mb-4">Leadership</p>
              <h2 id="founder-heading" className="text-3xl sm:text-4xl font-bold text-navy-800 leading-tight mb-6">
                10+ years in operational systems.{" "}
                <span className="text-slate-400 font-medium">Every engagement run personally.</span>
              </h2>
              <p className="text-slate-500 leading-relaxed mb-4">
                Isaac Drezdner has spent over a decade leading engineering teams through the work that determines how operations run: ERP implementations, integration architecture, workflow automation, and scaling platforms under real business pressure.
              </p>
              <p className="text-slate-500 leading-relaxed mb-8">
                Every engagement is led directly by Isaac. The person you speak to on the first call is the one assessing your systems, shaping the approach, and staying involved week over week.
              </p>
      ...
      <section className="py-20 bg-white border-t border-slate-100" aria-labelledby="how-we-think-heading">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-14 items-start">
            <div>
              <p className="text-blue-600 text-xs font-semibold tracking-[0.2em] uppercase mb-4">Our Perspective</p>
              <h2 id="how-we-think-heading" className="text-2xl sm:text-3xl font-bold text-navy-800 leading-snug">How we think</h2>
            </div>
            <div className="space-y-5 text-slate-500 text-base leading-relaxed">
              <p>Growth doesn&apos;t just add revenue. It adds complexity. The systems, workflows, and integrations that worked at an earlier stage start to strain.</p>
              <p>Most of these problems aren&apos;t purely technical. They&apos;re structural. Solving them requires someone who can see the business and the systems together.</p>
              <p>That&apos;s the work. Not strategy decks or outside recommendations, but direct involvement in the systems, decisions, and execution until the problem is actually resolved.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-14 items-start">
            <div>
              ...
              <h2 id="how-we-work-heading" className="text-2xl sm:text-3xl font-bold text-navy-800 leading-snug">How we work</h2>
            </div>
            <p className="text-slate-500 text-base leading-relaxed">
              Techon Partners operates as part of your leadership team, with direct accountability for outcomes and a focus on practical execution.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-navy-900 py-20" aria-label="Contact">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          <p className="text-slate-300 text-lg sm:text-xl leading-relaxed mb-8 max-w-xl mx-auto">
            If your systems or teams are starting to strain under growth, a short conversation is usually the best place to start.
          </p>
